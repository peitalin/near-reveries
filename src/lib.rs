...
impl PaymentContract {
    ...
    pub fn create_reverie(
        ...
        assert!(self.reverie_metadata.get(&reverie_id).is_none(), "ReverieId already exists");
        assert!(self.reverie_balances.get(&reverie_id).is_none(), "ReverieId already exists");
